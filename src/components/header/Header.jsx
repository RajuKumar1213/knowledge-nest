      ...
      <Container>
        <div className="container mx-auto flex items-center justify-between px-4">
          ...
          <Link to="/" className="flex items-center">
            <img src="/logo/owl-logo.png" alt="" className="h-16 inline relative right-2"/>
            <div className="text-2xl inline-block font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-yellow-700 to-yellow-500 drop-shadow-md">KnowledgeNest</div>
          </Link>
              ...
              {navList.map((item) =>
                item.active ? (
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `relative text-gray-300 font-semibold px-3 py-2 block transition duration-300 ease-in-out 
                       ${
                         isActive
                           ? "text-transparent bg-clip-text bg-gradient-to-r from-gray-600 to-gray-400"
                           : "hover:text-transparent hover:bg-clip-text hover:bg-gradient-to-r hover:from-gray-400 hover:to-gray-600"
                       }
                       before:content-[''] before:absolute before:left-0 before:bottom-0 before:h-[2px] before:w-full before:bg-gradient-to-r before:from-gray-400 before:to-gray-600
                       ${
                         isActive
                           ? "before:scale-x-100"
